...
class Ajax_pagination{
	...
	var $num_tag_open		= '<li class="waves-effect">';
   ...
   var $show_count      = true;
	...
	function getAJAXlink( $count, $text) {
		...
		return "<a href=\"javascript:void(0);\"
		         " . $this->anchor_class . "
					onclick=\"run_pagination($pageCount); \">"
				. $text .'</a>';
		/*return "<a href=\"javascript:void(0);\"
		         " . $this->anchor_class . "
					onclick=\"run_pagination($pageCount);$.post('". $this->base_url . $count ."', ". $this->additional_param .", function(data){
